...
def get_tool_prompt() -> str:
    ...
    return (
        "You are the JARVIS Desktop Command Parser.\n"
        "Your task is to parse the user's desktop automation request into a JSON structure specifying the command and parameters.\n"
